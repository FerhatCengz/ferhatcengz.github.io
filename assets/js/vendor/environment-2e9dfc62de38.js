(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
    ["environment"], {
                ...
                polyfill: function() {
                    ...
                    if (!("scrollBehavior" in o.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                        var r = t.HTMLElement || t.Element,
                            ...
                            n = (e = t.navigator.userAgent, RegExp("MSIE |Trident/|Edge/").test(e)) ? 1 : 0;
                    ...
                    function p(e, r, n) {
                        var c, a, f, p, d = i();
                        e === o.body ? (c = t, a = t.scrollX || t.pageXOffset, f = t.scrollY || t.pageYOffset, p = l.scroll) : (c = e, a = e.scrollLeft, f = e.scrollTop, p = s),
                            function e(o) {
                                var r, l, n, s = (i() - o.startTime) / 468;
                                r = .5 * (1 - Math.cos(Math.PI * (s = s > 1 ? 1 : s))), l = o.startX + (o.x - o.startX) * r, n = o.startY + (o.y - o.startY) * r, o.method.call(o.scrollable, l, n), (l !== o.x || n !== o.y) && t.requestAnimationFrame(e.bind(t, o))
                            }({
                                scrollable: c,
                                method: p,
                                startTime: d,
        ...
        36329: (e, t, o) => {
            ...
            var c = o(46426);
            (0, o(49237).nn)(), "undefined" != typeof document && (() => {
                if ((0, c.c)("remove_child_patch") && "function" == typeof Node && Node.prototype) {
                    let e = Node.prototype.removeChild;
                    Node.prototype.removeChild = function(t) {
                        try {
                            return e.apply(this, [t])
                        } catch (e) {
                            if (e instanceof Error && e.stack?.includes("react-lib")) return t;
                            throw e
                        }
                    }
                }
        ...
        95253: (e, t, o) => {
            ...
            let {
                getItem: c
            } = (0, n.Z)("localStorage"), a = "dimension_", f = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content", "scid"];
            try {
        ...
        22490: (e, t, o) => {
            ...
            let a = {
                    ...
                    createScript: c("createScript"),
                    createScriptURL: c("createScriptURL")
                },
                f = !1;
            try {
                f = (0, s.c)("global_trusted_types_map_off")
            } catch {}
            r = f ? new Map : (l = globalThis).__TRUSTED_TYPE_POLICIES__ ?? (l.__TRUSTED_TYPE_POLICIES__ = new Map);
            let p = globalThis.trustedTypes ?? {
                    createPolicy: (e, t) => ({
                        name: e,
                        ...a,
                        ...t
                ...
                d = {
                    createPolicy: (e, t) => {
                        if (r.has(e)) return (0, n.b)({
                            incrementKey: "TRUSTED_TYPES_POLICY_INITIALIZED_TWICE"
                        }), r.get(e);
                        {
                            let o = Object.freeze(p.createPolicy(e, t));
                            return r.set(e, o), o
                        }
                    }
                },
    ...
    e => {
        var t = t => e(e.s = t);
        e.O(0, ["vendors-node_modules_dompurify_dist_purify_js", "vendors-node_modules_stacktrace-parser_dist_stack-trace-parser_esm_js-node_modules_github_bro-a4c183", "vendors-node_modules_github_hydro-analytics-client_dist_analytics-client_js-node_modules_gith-6a10dd", "ui_packages_failbot_failbot_ts"], () => t(36329)), e.O()
    }
]);
//# sourceMappingURL=environment-c6f030ae223a.js.map