...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
    ["app_assets_modules_github_behaviors_ajax-error_ts-app_assets_modules_github_behaviors_include-467754", "ui_packages_soft-navigate_soft-navigate_ts"], {
        54679: (e, t, r) => {
            r.d(t, {
                H: () => o,
                v: () => a
            ...
            function o() {
                ...
                e.currentTarget === e.target && "abort" !== r && "canceled" !== r && (/<html/.test(n) ? (a(), e.stopImmediatePropagation()) : setTimeout(function() {
        ...
        93491: (e, t, r) => {
            ...
            function c(e, t, r) {
                ...
                for (let [e, r] of Object.entries(t)) o.searchParams.append(e, `${r}`);
                return o.hash = a, (0, n.dy)`
    <div
  ...
  `
            }(0, a.N7)(".js-render-needs-enrichment", {
                ...
                initialize: function(e) {
                    ...
                    u.classList.add("js-render-enrichment-fallback"), e.appendChild(u);
                    ...
                    let f = {
                        ...
                        setError: (e, t) => (f.setLoading(!1), !1 !== e && (m.classList.toggle("render-plaintext-hidden", !e), !!t && ((0, n.sY)([t, m], u), !0)))
                    };
                    d.set(e, f);
                    let h = l.getAttribute("data-plain"),
                        p = l.getAttribute("data-json");
                    if (null == p || null == h) throw f.setError(!0, (0, n.dy)`<p class="flash flash-error">Unable to render rich display</p>`), Error(`Expected to see input data for type: ${r}`);
                    let g = c(a, t, {
                            type: r,
                            identifier: o,
                            contentJson: p
  ...
  `;
    ...
    ${o}${a}
                            ...
                            (0, n.sY)(v, l.getElementsByClassName("Box-body")[0])
                        }, {
                            type: r
                        });
                    (0, n.sY)([y, g], l)
                }
            }), (0, o.on)("preview:toggle:off", ".js-previewable-comment-form", function(e) {
                let t = e.currentTarget,
                    r = t.querySelector(".js-render-needs-enrichment"),
                    n = r?.querySelector(".js-render-enrichment-target");
                n && (n.textContent = "")
            }), (0, o.on)("preview:rendered", ".js-previewable-comment-form", function(e) {
                let t = e.currentTarget,
                    r = t.querySelector(".js-render-needs-enrichment");
        ...
        52191: (e, t, r) => {
            ...
            function i(e, t) {
                ...
                if (r instanceof Element) {
                    for (let e of r.querySelectorAll("[data-show-on-error]")) e instanceof HTMLElement && (e.hidden = !t);
                    for (let e of r.querySelectorAll("[data-hide-on-error]")) e instanceof HTMLElement && (e.hidden = t)
                }
            }
            ...
            }), (0, o.on)("click", "include-fragment button[data-retry-button]", ({
                currentTarget: e
            }) => {
      ...
      <p>${r.map(e=>(0,n.dy)`${e}<br />`)}</p>`
            ...
            function f(e, t = !1) {
                !(!(0, i.Z)(e) || e.classList.contains("is-render-ready") || e.classList.contains("is-render-failed") || e.classList.contains("is-render-failed-fatally")) && (!t || c.get(e)?.hello) && m(e)
            }
            ...
            function p(e) {
            ...
            }(0, o.N7)(".js-render-target", function(e) {
                e.classList.remove(...s), e.style.height = "auto", !c.get(e)?.load && (u(e), c.get(e) || (c.set(e, {
                    load: Date.now(),
                    hello: null,
                ...
                switch (n) {
                    ...
                    case "error":
                        ...
                        break;
                    case "error:fatal":
                        m(o, i?.error), o.classList.add("is-render-failed-fatal");
                        break;
                    case "error:invalid":
                        m(o, i?.error), o.classList.add("is-render-failed-invalid");
                        break;
                    case "loading":
                        o.classList.remove(...l), o.classList.add("is-render-loading");
                        break;
                    case "loaded":
                        o.classList.remove(...l), o.classList.add("is-render-loaded");
                        break;
                    case "ready":
                        (0, a.I)(o), o.classList.remove(...l), o.classList.add("is-render-ready"), i && "number" == typeof i.height && (o.style.height = `${i.height}px`, "" !== location.hash && window.dispatchEvent(new HashChangeEvent("hashchange"))), i?.ack === !0 && window.requestAnimationFrame(() => {
                            setTimeout(() => {
                                h(s, {
                                    type: "render:cmd",
                                    body: {
        ...
        76237: (e, t, r) => {
            ...
            function u(e = "light") {
                ...
                if (await n.x, o(), window.matchMedia) {
        ...
        15345: (e, t, r) => {
            ...
            function a(e, t) {
                o((e.getAttribute("aria-label") || e.innerText || "").trim(), t)
            }
        ...
        64325: (e, t, r) => {
            ...
            function i(e, t = !1) {
                ...
                !1 === t && (r = `.${r}`);
                try {
                    document.cookie = `${e}=''; path=/; domain=${r}${i}${o}`
                } catch {}
            }
            r.d(t, {
                $1: () => a,
        ...
        75214: (e, t, r) => {
            ...
            function l() {
                d = 0, document.dispatchEvent(new Event(n.Q.INITIAL)), (0, i.XL)()
            }

            function s(e) {
                (0, i.sj)() || (document.dispatchEvent(new Event(n.Q.PROGRESS_BAR.START)), document.dispatchEvent(new a.OV(e)), (0, i.U6)(e), (0, i.J$)(), (0, i.Nt)(), (0, o.hY)())
            }

            function c(e = {}) {
                g(e) && (d += 1, document.dispatchEvent(new a.$g((0, i.Gj)(), d)), m(e))
            }
            ...
            function u(e = {}) {
                ...
                d = 0;
                let t = (0, i.Wl)() || i.jN;
                document.dispatchEvent(new a.QW((0, i.Gj)(), t)), p(), (0, o.t3)(t), (0, i.XL)()
            }

            function m(e = {}) {
                if (!g(e)) return;
                let t = (0, i.Gj)();
                p(), document.dispatchEvent(new a.Xr(t)), (0, i.pS)(), (0, i.vu)(t)
            }

            function f(e = {}) {
                g(e) && ((0, o.mr)(), document.dispatchEvent(new Event(n.Q.RENDER)))
            }
            ...
            function g({
                ...
                return (0, i.sj)() && (0 === t.length || t.includes((0, i.Gj)())) && (!e || !(0, i.Nb)())
            }
        },
        55009: (e, t, r) => {
            r.d(t, {
            ...
            function d() {
                performance.clearResourceTimings(), performance.mark(o)
            }

            function l(e) {
                (0, n.b)({
                    turboFailureReason: e,
                    turboStartUrl: (0, a.wP)(),
            ...
            function s() {
                let e = function() {
                    if (0 === performance.getEntriesByName(o).length) return null;
                    performance.measure(o, o);
                    let e = performance.getEntriesByName(o),
                        t = e.pop();
                ...
                t === i.react && document.dispatchEvent(new CustomEvent("staffbar-update", {
                    ...
                    softNavigationTiming: {
                        mechanism: t,
                        destination: (0, a.Nb)() || "rails",
                        duration: r,
                        initiator: (0, a.CI)() || "rails"
                    }
                })
            }
        },
...
//# sourceMappingURL=app_assets_modules_github_behaviors_ajax-error_ts-app_assets_modules_github_behaviors_include-467754-f268566d6e09.js.map